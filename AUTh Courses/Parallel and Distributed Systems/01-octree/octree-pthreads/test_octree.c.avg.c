...
int main(int argc, char** argv){
  ...
  double hash_avg = 0, morton_avg = 0, sort_avg = 0 , rearrange_avg = 0;

  if (argc != 1 + 6) { // Check if the command line arguments are correct 
  ...
  nthreads = atoi(argv[6]); // number of threads
